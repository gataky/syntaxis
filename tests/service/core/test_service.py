...
class TestServiceV2Templates:
    ...
    def test_generate_from_v2_template_with_multiple_groups(
        self, service, mock_syntaxis
    ):
    ...
    def test_generate_from_v2_template_with_direct_features(
        self, service, mock_syntaxis
    ):
        ...
        mock_article = Mock()
        mock_article.to_json.return_value = {
            "lemma": "ο",
